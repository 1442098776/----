		...
		<div class="hmtop">
			...
			<div class="am-container header">
				...
				<ul class="message-r">
					<div class="topMessage home">
						<div class="menu-hd"><a href="<%=request.getContextPath()%>/public/home.action" target="_top" class="h">商城首页</a></div>
					</div>
			...
			<div class="shopNav">
				<div class="slideall">
					   ...
					   <div class="nav-cont">
							<ul>
								<li class="index"><a href="<%=request.getContextPath()%>/public/home.action">首页</a></li>
								<!--  
						...
						<div id="nav" class="navfull">
							<div class="area clearfix">
								<div class="category-content" id="guide_2">
									<div class="category">
										<ul class="category-list" id="js_climit_li" style="background-color:#D2364C">
										<c:forEach items="${ MenuList}" var="menu">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="../img/${menu.img }"></i><a class="ml-22" title="${menu.name }">${menu.name }</a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		<dt><span title="蛋糕">${menu.name }</span></dt>
																		<c:forEach items="${menu.list }" var="sonmenu">
																		<dd><a title="蒸蛋糕" href="#"><span>${sonmenu.name }</span></a></dd>
																		</c:forEach>
																	</dl>
																</div>
															</div>
